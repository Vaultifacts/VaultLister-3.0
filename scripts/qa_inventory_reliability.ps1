...
- API, worker, service, and shared automation/AI files
- test framework/config files
- CI config if present

Task:
Audit current coverage only for the Architecture and Reliability domain.
...
3. Update qa/coverage_matrix.md with:
   ...
   - Missing Coverage
   - Last Updated
4. Create qa/reports/audits/architecture_reliability_audit.md summarizing:
   - verified strengths
   - verified gaps
