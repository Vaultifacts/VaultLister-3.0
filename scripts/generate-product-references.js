...
const CATEGORIES = {
    "Women's Clothing": [
        ...
        { brand: 'American Eagle', name: 'Jeans', subcategory: 'Bottoms' },
        { brand: 'American Eagle', name: 'Hoodie', subcategory: 'Tops' },
        { brand: 'American Eagle', name: 'Flannel Shirt', subcategory: 'Tops' },
        { brand: 'Abercrombie & Fitch', name: 'Jeans', subcategory: 'Bottoms' },
        { brand: 'Abercrombie & Fitch', name: 'Curve Love Jeans', subcategory: 'Bottoms' },
        { brand: 'Abercrombie & Fitch', name: 'Hoodie', subcategory: 'Tops' },
        { brand: 'Gap', name: 'Vintage Hoodie', subcategory: 'Tops' },
        { brand: 'Gap', name: 'Jeans', subcategory: 'Bottoms' },
    ],
    ...
    "Men's Clothing": [
        ...
        { brand: 'Supreme', name: 'Box Logo Tee', subcategory: 'Streetwear' },
        { brand: 'Supreme', name: 'Box Logo Hoodie', subcategory: 'Streetwear' },
        { brand: 'Supreme', name: 'Box Logo Crewneck', subcategory: 'Streetwear' },
        { brand: 'Fear of God Essentials', name: 'Hoodie', subcategory: 'Streetwear' },
        { brand: 'Fear of God Essentials', name: 'Sweatpants', subcategory: 'Streetwear' },
        { brand: 'Fear of God Essentials', name: 'Tee', subcategory: 'Streetwear' },
        { brand: 'Fear of God Essentials', name: 'Shorts', subcategory: 'Streetwear' },
        { brand: 'BAPE', name: 'Shark Full Zip Hoodie', subcategory: 'Streetwear' },
        { brand: 'BAPE', name: 'Full Zip Hoodie', subcategory: 'Streetwear' },
        { brand: 'BAPE', name: 'Graphic Tee', subcategory: 'Streetwear' },
        { brand: 'Stone Island', name: 'Knit Sweater', subcategory: 'Streetwear' },
        { brand: 'Stone Island', name: 'Nylon Jacket', subcategory: 'Streetwear' },
        { brand: 'Carhartt WIP', name: 'Chore Coat', subcategory: 'Streetwear' },
        { brand: 'Carhartt WIP', name: 'Double Knee Pants', subcategory: 'Streetwear' },
        { brand: 'Carhartt WIP', name: 'OG Chino Pant', subcategory: 'Streetwear' },
        { brand: 'Stüssy', name: 'Stock Logo Tee', subcategory: 'Streetwear' },
        { brand: 'Stüssy', name: '8-Ball Fleece', subcategory: 'Streetwear' },
        { brand: 'Palace', name: 'Tri-Ferg Tee', subcategory: 'Streetwear' },
        { brand: 'Palace', name: 'Hoodie', subcategory: 'Streetwear' },
        { brand: 'Kith', name: 'Logo Tee', subcategory: 'Streetwear' },
        { brand: 'Kith', name: 'Hoodie', subcategory: 'Streetwear' },
        { brand: 'Off-White', name: 'Industrial Belt Tee', subcategory: 'Streetwear' },
        { brand: 'Off-White', name: 'Hoodie', subcategory: 'Streetwear' },
    ],
    ...
    'Activewear': [
        ...
        { brand: 'Lululemon', name: 'Everywhere Belt Bag', subcategory: 'Bags' },
        { brand: 'Lululemon', name: 'Groove Pant', subcategory: 'Bottoms' },
        { brand: 'Lululemon', name: 'Wunder Train Tights', subcategory: 'Bottoms' },
        { brand: 'Lululemon', name: 'Align Shorts', subcategory: 'Bottoms' },
        { brand: 'Lululemon', name: 'Invisifit Tank', subcategory: 'Tops' },
        { brand: 'Nike', name: 'Windrunner Jacket', subcategory: 'Jackets' },
        { brand: 'Nike', name: 'Windrunner Hoodie', subcategory: 'Hoodies' },
    ],
    ...
    'Outerwear': [
        ...
        { brand: 'Patagonia', name: 'Synchilla Snap-T Fleece', subcategory: 'Fleece' },
    ...
    'Sports Equipment': [
        { brand: 'Stanley', name: 'Quencher 40oz Tumbler', subcategory: 'Tumblers' },
        { brand: 'Stanley', name: 'Quencher 30oz Tumbler', subcategory: 'Tumblers' },
        { brand: 'Stanley', name: 'IceFlow Flip Straw Tumbler', subcategory: 'Tumblers' },
        { brand: 'Stanley', name: 'Adventure Quencher Travel Tumbler', subcategory: 'Tumblers' },
        { brand: 'Mitchell & Ness', name: 'NBA Authentic Jersey', subcategory: 'Jerseys' },
        { brand: 'Mitchell & Ness', name: 'Hardwood Classics Swingman Jersey', subcategory: 'Jerseys' },
        { brand: 'Mitchell & Ness', name: 'NFL Legacy Jersey', subcategory: 'Jerseys' },
    ...
    'Baby & Kids': [
        ...
        { brand: "Carter's", name: 'Pajama Set', subcategory: 'Sleepwear' },
        { brand: "Carter's", name: 'Onesie Bundle', subcategory: 'Bodysuits' },
        { brand: "Carter's", name: 'Outfit Set', subcategory: 'Sets' },
        { brand: 'Gap Kids', name: 'Hoodie', subcategory: 'Tops' },
        { brand: 'Gap Kids', name: 'Jeans', subcategory: 'Bottoms' },
        { brand: 'Old Navy Kids', name: 'Fleece Zip-Up', subcategory: 'Outerwear' },
        { brand: 'Old Navy Kids', name: 'Jeans', subcategory: 'Bottoms' },
        { brand: 'H&M Kids', name: 'Outfit Set', subcategory: 'Sets' },
        { brand: 'The North Face Kids', name: 'Nuptse Jacket', subcategory: 'Outerwear' },
        { brand: 'The North Face Kids', name: 'Fleece Jacket', subcategory: 'Outerwear' },
        { brand: 'Patagonia Kids', name: 'Down Sweater', subcategory: 'Outerwear' },
    ],
    ...
    'Trading Cards': [
        { brand: 'Pokémon', name: 'Base Set Charizard', subcategory: 'Vintage Pokemon' },
        { brand: 'Pokémon', name: 'Holographic Rare Card', subcategory: 'Vintage Pokemon' },
        { brand: 'Pokémon', name: 'Scarlet & Violet Booster Box', subcategory: 'Booster Boxes' },
        { brand: 'Pokémon', name: 'Elite Trainer Box', subcategory: 'Sealed Product' },
        { brand: 'Pokémon', name: 'PSA Graded Card', subcategory: 'Graded Pokemon' },
        { brand: 'Pokémon', name: 'Vintage Booster Pack', subcategory: 'Vintage Pokemon' },
        { brand: 'Magic: The Gathering', name: 'Black Lotus', subcategory: 'Reserved List' },
        { brand: 'Magic: The Gathering', name: 'Commander Deck', subcategory: 'Commander' },
        { brand: 'Magic: The Gathering', name: 'Booster Box', subcategory: 'Booster Boxes' },
        { brand: 'Magic: The Gathering', name: 'Mox Sapphire', subcategory: 'Reserved List' },
        { brand: 'Yu-Gi-Oh', name: 'First Edition Card', subcategory: 'Vintage Yu-Gi-Oh' },
        { brand: 'Yu-Gi-Oh', name: 'Ghost Rare Card', subcategory: 'Rare Cards' },
        { brand: 'Yu-Gi-Oh', name: 'Booster Box', subcategory: 'Booster Boxes' },
        { brand: 'Topps', name: 'LeBron James Rookie Card', subcategory: 'Basketball Cards' },
        { brand: 'Panini Prizm', name: 'Patrick Mahomes Rookie Card', subcategory: 'Football Cards' },
        { brand: 'Panini Prizm', name: 'Stephen Curry Prizm Card', subcategory: 'Basketball Cards' },
        { brand: 'Upper Deck', name: 'Michael Jordan Rookie Card', subcategory: 'Basketball Cards' },
        { brand: 'Topps Chrome', name: 'Shohei Ohtani Card', subcategory: 'Baseball Cards' },
        { brand: 'Panini Prizm', name: 'Caitlin Clark Rookie Card', subcategory: 'Basketball Cards' },
        { brand: 'Topps', name: 'Tom Brady Rookie Card', subcategory: 'Football Cards' },
        { brand: 'PSA Graded', name: 'PSA 10 Sports Card', subcategory: 'Graded Cards' },
        { brand: 'BGS Graded', name: 'BGS 9.5 Sports Card', subcategory: 'Graded Cards' },
    ],

    'K-pop & Anime Merchandise': [
        { brand: 'BTS', name: 'Official Album', subcategory: 'K-pop Albums' },
        { brand: 'BTS', name: 'Photocard', subcategory: 'Photocards' },
        { brand: 'BTS', name: 'ARMY Bomb Light Stick', subcategory: 'Light Sticks' },
        { brand: 'BTS', name: 'Concert Merchandise', subcategory: 'Concert Merch' },
        { brand: 'Blackpink', name: 'Official Album', subcategory: 'K-pop Albums' },
        { brand: 'Blackpink', name: 'Bong Bong Light Stick', subcategory: 'Light Sticks' },
        { brand: 'Blackpink', name: 'Photocard', subcategory: 'Photocards' },
        { brand: 'Stray Kids', name: 'Official Album', subcategory: 'K-pop Albums' },
        { brand: 'Stray Kids', name: 'Photocard', subcategory: 'Photocards' },
        { brand: 'Seventeen', name: 'Official Album', subcategory: 'K-pop Albums' },
        { brand: 'Twice', name: 'Official Album', subcategory: 'K-pop Albums' },
        { brand: 'Twice', name: 'Candy Bong Light Stick', subcategory: 'Light Sticks' },
        { brand: 'One Piece', name: 'Luffy Figure', subcategory: 'Anime Figures' },
        { brand: 'Dragon Ball Z', name: 'Goku Figure', subcategory: 'Anime Figures' },
        { brand: 'Naruto', name: 'Naruto Figure', subcategory: 'Anime Figures' },
        { brand: 'Demon Slayer', name: 'Tanjiro Figure', subcategory: 'Anime Figures' },
        { brand: 'Jujutsu Kaisen', name: 'Gojo Figure', subcategory: 'Anime Figures' },
        { brand: 'Attack on Titan', name: 'Levi Figure', subcategory: 'Anime Figures' },
        { brand: 'My Hero Academia', name: 'Deku Figure', subcategory: 'Anime Figures' },
        { brand: 'Nendoroid', name: 'Anime Nendoroid Figure', subcategory: 'Nendoroids' },
        { brand: 'Funko Pop Anime', name: 'Anime Funko Pop', subcategory: 'Funko Pop Anime' },
    ],

    'Vintage & Y2K Clothing': [
        { brand: 'Vintage Band Tee', name: 'Metallica Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'Nirvana Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'Pink Floyd Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'AC/DC Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'Grateful Dead Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'Rap Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Band Tee', name: 'Led Zeppelin Tee', subcategory: 'Band Tees' },
        { brand: 'Vintage Sports', name: 'NBA Vintage Jersey', subcategory: 'Jerseys' },
        { brand: 'Vintage Sports', name: 'NFL Vintage Jersey', subcategory: 'Jerseys' },
        { brand: 'Vintage Sports', name: 'NHL Hockey Jersey', subcategory: 'Jerseys' },
        { brand: 'Starter', name: 'Vintage Starter Jacket', subcategory: 'Jackets' },
        { brand: 'NASCAR', name: 'Racing Shirt', subcategory: 'Tops' },
        { brand: 'Von Dutch', name: 'Trucker Hat', subcategory: 'Hats' },
        { brand: 'Juicy Couture', name: 'Velour Tracksuit', subcategory: 'Sets' },
        { brand: 'Juicy Couture', name: 'Velour Hoodie', subcategory: 'Tops' },
        { brand: 'Ed Hardy', name: 'Graphic Tee', subcategory: 'Tops' },
        { brand: 'Ed Hardy', name: 'Hoodie', subcategory: 'Tops' },
        { brand: 'Tommy Hilfiger', name: 'Vintage Flag Tee', subcategory: 'Vintage' },
        { brand: 'Tommy Hilfiger', name: 'Vintage Windbreaker', subcategory: 'Vintage' },
        { brand: 'Polo Sport', name: 'Vintage Tee', subcategory: 'Vintage' },
        { brand: 'Polo Sport', name: 'Vintage Windbreaker', subcategory: 'Vintage' },
        { brand: 'Nautica', name: 'Vintage Jacket', subcategory: 'Vintage' },
        { brand: 'FUBU', name: 'Vintage Tee', subcategory: 'Y2K' },
        { brand: 'JNCO', name: 'Wide Leg Jeans', subcategory: 'Y2K' },
        { brand: 'Abercrombie & Fitch', name: 'Vintage Henley', subcategory: 'Y2K' },
    ],

    'Etsy Personalized Items': [
        { brand: 'Personalized Jewelry', name: 'Custom Name Necklace', subcategory: 'Custom Jewelry' },
        { brand: 'Personalized Jewelry', name: 'Initial Ring', subcategory: 'Custom Jewelry' },
        { brand: 'Personalized Jewelry', name: 'Birth Month Flower Necklace', subcategory: 'Custom Jewelry' },
        { brand: 'Personalized Jewelry', name: 'Zodiac Necklace', subcategory: 'Custom Jewelry' },
        { brand: 'Personalized Jewelry', name: 'Custom Coordinates Bracelet', subcategory: 'Custom Jewelry' },
        { brand: 'Personalized Jewelry', name: 'Custom Wedding Jewelry Set', subcategory: 'Bridal' },
        { brand: 'Personalized Jewelry', name: 'Engraved Signet Ring', subcategory: 'Custom Jewelry' },
        { brand: 'Custom Home Decor', name: 'Personalized Cutting Board', subcategory: 'Kitchen' },
        { brand: 'Custom Home Decor', name: 'Custom Family Name Sign', subcategory: 'Wall Decor' },
        { brand: 'Custom Home Decor', name: 'Personalized Throw Pillow', subcategory: 'Pillows' },
        { brand: 'Custom Home Decor', name: 'Custom Map Print', subcategory: 'Art Prints' },
        { brand: 'Custom Home Decor', name: 'Personalized Pet Portrait Print', subcategory: 'Art Prints' },
        { brand: 'Custom Home Decor', name: 'Custom Photo Canvas', subcategory: 'Canvas Art' },
        { brand: 'Custom Home Decor', name: 'Personalized Mug', subcategory: 'Mugs' },
        { brand: 'Custom Home Decor', name: 'Custom Wedding Guest Book', subcategory: 'Wedding' },
        { brand: 'Digital Downloads', name: 'Printable Wall Art', subcategory: 'Digital Art' },
        { brand: 'Digital Downloads', name: 'Printable Planner', subcategory: 'Digital Planners' },
        { brand: 'Digital Downloads', name: 'SVG Cut File', subcategory: 'SVG Files' },
        { brand: 'Handmade Candles', name: 'Soy Wax Candle', subcategory: 'Candles' },
        { brand: 'Handmade Candles', name: 'Custom Scented Candle Set', subcategory: 'Candles' },
    ],
};
