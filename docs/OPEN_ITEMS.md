...
| .github/workflows/cloudflare-ops.yml | 5 | 139 | Config/workflow text; parsed separately only if promoted |
...
| memory/STATUS.md | 13 | 7 | Excluded: session memory, promote only after current verification |
...
| docs/reference/deep-dive-backlog.md | 6 | 1 | Included as structural/refactor backlog |
