...
| P1-pub-1 | NOT DEPLOYED ❌ — sidebar HTML has no logo element (only CSS .sidebar-logo class exists unused); logo is absent from aside.sidebar template in core-bundle.js |  | Sidebar | Migrate logo from top bar back to sidebar; sidebar extends to top of page (image-53) | docs/walkthrough/public-site.md:66 |  |  |
...
| P3-pub-11 | NOT DEPLOYED ❌ — live feature-requests.html has 0 input elements; local patch not committed |  | Feature Requests | Add a search bar under feature requests (image-78) | docs/walkthrough/public-site.md:79 |  |  |
| P3-pub-12 | NOT DEPLOYED ❌ — live learning.html has 0 input elements; "search" appears only in article body text |  | Learning Page | Add a search bar to the Learning page (image-106) | docs/walkthrough/public-site.md:80 |  |  |
