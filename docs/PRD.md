...
- **Cross-listing** - 7 platforms (Poshmark, eBay, Mercari, Depop, Grailed, Whatnot, Facebook), Advanced Cross-List modal
...
### My Shops Page
- [x] Platform logos (platformLogoLarge component for all 7 platforms)
