...
| # | Page / Component | Issue | Session | Status |
|---|-----------------|-------|---------|--------|
| #193 | Inventory | Search bar does not filter in real time as characters are typed, and does not filter even when Enter is pressed | 2026-04-08 | FIXED — 1fcf99a |
| #194 | Inventory | Unable to add filters — filter controls have no effect | 2026-04-08 | FIXED — 1fcf99a |
| #197 | Inventory | Analytics on Inventory page will not load and displays error toasts | 2026-04-08 | FIXED — 1fcf99a |
| #200 | Listings | Adding a folder creates two folders — duplication bug on every folder create action | 2026-04-08 | FIXED — 1fcf99a |
| #204 | Listings | Nothing happens when Advanced Crosslist option is chosen — feature is entirely non-functional | 2026-04-08 | FIXED — 1fcf99a |
| #216 | Automations | No available automations for users to choose from — automations list is empty. Automations shown should only be ones feasibly executable by the platform | 2026-04-08 | FIXED — 05f419d |
| #217 | Financials | Health text is displaying behind the Health score number — text is obscured and unreadable | 2026-04-08 | FIXED — 1fcf99a |
| #223 | Analytics | Load time when navigating to Analytics from the sidebar is extremely delayed and glitchy | 2026-04-08 | FIXED — 05f419d |
| #232 | Planner | Streak text is not visible without highlighting — invisible in both light and dark mode | 2026-04-08 | FIXED — 1fcf99a |
...
| # | Page / Component | Issue | Session | Status |
|---|-----------------|-------|---------|--------|
| #191 | Inventory | No items show in Restock Suggestions even though 3 items have "Stock Low - Reorder" stock level set | 2026-04-08 | FIXED — 1fcf99a |
| #195 | Inventory | Exported Excel sheet does not mirror the user's column order, detail format, or column selection | 2026-04-08 | FIXED — 05f419d |
| #199 | Listings | Listing Health Score displays a value with no listings analyzed — should show empty state message e.g. "Add listings to see your Listing Health Score". Additionally: Good should be colour-coded yellow, Needs Work should be colour-coded red (matching existing Excellent = green) | 2026-04-08 | FIXED — 1fcf99a |
| #201 | Listings | Remove the Fee Breakdown section entirely — instead integrate all fee details directly onto each platform listing card | 2026-04-08 | FIXED — 05f419d |
| #202 | Listings | UI is broken/messed up on the Add New Listings dropdown menu | 2026-04-08 | FIXED — 1fcf99a |
...
| #209 | Orders & Sales | Shipping popup should be migrated to a popout menu beside the Create Label popup. Missing: (1) Canadian postal code format support — only US zip code format currently supported; (2) weight measurement options — oz is the only available unit | 2026-04-08 | FIXED — 05f419d |
| #210 | Orders & Sales | "More" dropdown menu UI is broken/messed up | 2026-04-08 | FIXED — 1fcf99a |
| #211 | Automations | Remove the following options from the Automations page: Create Custom Automation, Templates, Export, Import, URL rules, and CSV rules. Platform should offer pre-built automations only | 2026-04-08 | FIXED — 1fcf99a |
| #212 | Automations | Automation cards display with large gaps between them — should display compactly with only small padding between cards, no large unused whitespace | 2026-04-08 | FIXED — 1fcf99a |
| #213 | Automations | (1) No option to manually resize cards as available on the Dashboard; (2) no Customize option to choose which cards to show; (3) collapse buttons missing on some cards; (4) cards that do have collapse buttons are showing the arrow horizontally instead of vertically | 2026-04-08 | FIXED — 1fcf99a |
| #214 | Automations | Many duplicated metrics across cards — e.g. Success Rate appears multiple times. The "System Active" card should function as the main status, statistics, and informational hub for the page; duplicate information from other cards should be removed and shown only there | 2026-04-08 | FIXED — 05f419d |
| #219 | Financials | Export dropdown menu UI is broken/misaligned | 2026-04-08 | FIXED — 1fcf99a |
| #220 | Financials | Revenue, Expenses, Net Profit, and Profit Margin summary cards below the main Financial Overview are duplicate information — remove all four | 2026-04-08 | FIXED — 1fcf99a |
| #221 | Financials | Chart of Accounts tab is missing "Purchases" and "Sales" tabs on the left side | 2026-04-08 | FIXED — 05f419d |
...
| # | Page / Component | Issue | Session | Status |
|---|-----------------|-------|---------|--------|
| #192 | Inventory | Quick Item Lookup should trigger after only 1 character is typed — current minimum threshold is too high | 2026-04-08 | FIXED — 1fcf99a |
| #198 | Listings | Breadcrumb shows "Home > My Listings" — should display "Dashboard > Listings" to match actual page names | 2026-04-08 | FIXED — 1fcf99a |
