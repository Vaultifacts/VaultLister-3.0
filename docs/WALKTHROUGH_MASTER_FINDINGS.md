...
| #152 | Dashboard | Log Sale crashes: "Failed to log sale: Cannot read properties of undefined (reading 'get')" — same `db.get()` crash as #150 | Session 7 | OPEN — crash source not locatable in frontend source; likely same root cause as #150 undefined.get() systemic issue |
