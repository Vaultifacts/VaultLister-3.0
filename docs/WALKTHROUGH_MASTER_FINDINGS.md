...
🔴 High
3. "Latest" badge appears on ALL versions when that version is selected as a filter — VERIFIED ✅ — [this commit] — badge now checks version.version === versions[0].version instead of vIdx===0
