...
| # | Page / Component | Issue | Session | Status |
|---|-----------------|-------|---------|--------|
| MANUAL-road-1 | Roadmap | Please format our roadmap page in a kanban board structure (image-27) | Backlog | VERIFIED ✅ — kanban board with 4 columns (Feature Requests → Planned → In Progress → Released) implemented in pages-community-help.js:1332-1337 |
| MANUAL-road-2 | Roadmap | Please add a kanban section for "Feature Requests" and place it 1st, then put Features Planned 2nd, then Features In Progress 3rd and Released Features 4th (image-43) | Backlog | VERIFIED ✅ — columns.map() at line 1433 renders all 4 columns in exact order specified |
| MANUAL-road-3 | Roadmap | Components should be Platforms → eBay, Poshmark, Depop, Facebook, Whatnot, Shopify (image-44) | Backlog | VERIFIED ✅ — componentPlatforms = ['eBay', 'Poshmark', 'Depop', 'Facebook', 'Whatnot', 'Shopify'] at line 1345 |
