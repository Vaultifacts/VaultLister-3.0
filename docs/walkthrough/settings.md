...
| FIXED — Settings sidebar tab targeting so the clicked tab renders immediately (image-80) | VERIFIED LIVE ✅ 2026-05-01 — settings tab routing confirmed functional on live site |
...
| MANUAL-settings-3 | Settings | Add Currency (CAD) and Language (EN) dropdown menus next to the Timezone field in Account tab (image-83, image-84) | Backlog | VERIFIED LIVE ✅ 2026-05-01 — CAD/EN dropdowns beside Timezone confirmed on live settings Account tab |
