...
| P0-pub-4 | Assets | Old logo showing on page refresh (image-87) | FIXED -- 2026-04-23 local patch; live/manual recheck pending |
...
| P1-pub-3 | Sidebar | Remove 5 deprecated tabs from the sidebar menu (image-105) | FIXED -- 2026-04-24 local sidebar source patch; live/manual recheck pending |
...
| P3-pub-5 | Help Center | Make all Related Articles buttons display in a single row (image-68) | FIXED -- local Help Center source already matches; live/manual recheck pending |
