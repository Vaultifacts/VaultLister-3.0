...
const TOUR_STEPS = {
    reseller: [
        { step_id: 'welcome', title: 'Welcome to VaultLister', description: 'Let\'s get you started with the basics of managing your reselling business.', target_element: '#dashboard', position: 'center' },
        { step_id: 'add_inventory', title: 'Add Your First Item', description: 'Click here to add items to your inventory. You can add single items or bulk import.', target_element: '#nav-inventory', position: 'right' },
        { step_id: 'create_listing', title: 'Create Listings', description: 'Turn your inventory into live listings on marketplaces like eBay, Poshmark, and Mercari.', target_element: '#nav-listings', position: 'right' },
        { step_id: 'connect_shop', title: 'Connect Your Shop', description: 'Link your marketplace accounts to sync listings and orders automatically.', target_element: '#nav-settings', position: 'right' },
        { step_id: 'first_sale', title: 'Track Your Sales', description: 'View orders, manage shipments, and track your revenue all in one place.', target_element: '#nav-orders', position: 'right' },
        { step_id: 'analytics_overview', title: 'Understand Your Business', description: 'Use analytics to see what\'s selling, profit margins, and trends over time.', target_element: '#nav-analytics', position: 'right' }
    ],
    bulk_seller: [
        { step_id: 'welcome', title: 'Welcome, Bulk Seller', description: 'Manage high-volume inventory with automation and batch tools.', target_element: '#dashboard', position: 'center' },
        { step_id: 'bulk_import', title: 'Bulk Import Inventory', description: 'Import hundreds of items at once using CSV templates or receipt scanning.', target_element: '#nav-inventory', position: 'right' },
        { step_id: 'sku_setup', title: 'SKU & Organization', description: 'Set up SKU rules and organize inventory with bins and locations.', target_element: '#inventory-settings', position: 'left' },
        { step_id: 'pricing_rules', title: 'Automated Pricing', description: 'Create pricing rules based on cost, category, and market trends.', target_element: '#nav-automations', position: 'right' },
        { step_id: 'batch_photos', title: 'Batch Photo Processing', description: 'Apply watermarks, resize, and organize photos for hundreds of items.', target_element: '#nav-image-bank', position: 'right' },
        { step_id: 'shipping_profiles', title: 'Shipping Profiles', description: 'Create templates for fast, accurate shipping across all your listings.', target_element: '#shipping-settings', position: 'left' }
    ],
    live_streamer: [
        { step_id: 'welcome', title: 'Welcome, Live Streamer', description: 'Set up your Whatnot events and stage inventory for live selling.', target_element: '#dashboard', position: 'center' },
        { step_id: 'whatnot_setup', title: 'Connect Whatnot', description: 'Link your Whatnot account to sync events and track live sales.', target_element: '#nav-settings', position: 'right' },
        { step_id: 'stage_items', title: 'Stage Your Show', description: 'Select and organize inventory for your upcoming live streams.', target_element: '#nav-calendar', position: 'right' },
        { step_id: 'go_live_tips', title: 'Go Live Prepared', description: 'Use staging tools, co-host management, and flash pricing.', target_element: '#live-controls', position: 'left' },
        { step_id: 'post_stream_analytics', title: 'Post-Stream Insights', description: 'Review performance, engagement, and revenue after each stream.', target_element: '#nav-analytics', position: 'right' }
    ],
    supplier: [
        { step_id: 'welcome', title: 'Welcome, Supplier', description: 'Manage wholesale operations and track buyer relationships.', target_element: '#dashboard', position: 'center' },
        { step_id: 'add_buyers', title: 'Add Buyers', description: 'Track your customer relationships and order history.', target_element: '#nav-suppliers', position: 'right' },
        { step_id: 'bulk_inventory', title: 'Manage Bulk Stock', description: 'Organize large quantities and warehouse locations.', target_element: '#nav-inventory', position: 'right' },
        { step_id: 'wholesale_pricing', title: 'Wholesale Pricing', description: 'Set tiered pricing and volume discounts.', target_element: '#pricing-settings', position: 'left' },
        { step_id: 'order_management', title: 'Process Orders', description: 'Manage bulk orders, invoicing, and shipments.', target_element: '#nav-orders', position: 'right' }
    ]
};
