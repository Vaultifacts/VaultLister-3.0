...
export async function feedbackRouter(ctx) {
    ...
    if (method === 'GET' && path === '/trending') {
        try {
            ...
            logger.error('[Feedback] error fetching trending feedback', user?.id, { detail: error?.message || 'Unknown error' });
    ...
    if (method === 'GET' && path === '/analytics') {
        ...
        try {
            ...
            logger.error('[Feedback] error fetching feedback analytics', user?.id, { detail: error?.message || 'Unknown error' });
    ...
    if (method === 'GET' && path === '/similar') {
        ...
        try {
            ...
            logger.error('[Feedback] error searching similar feedback', user?.id, { detail: error?.message || 'Unknown error' });
    ...
    if (method === 'GET' && path === '/user') {
        ...
        try {
            ...
            logger.error('[Feedback] error fetching user feedback', user?.id, { detail: error?.message || 'Unknown error' });
            return {
                status: 500,
                data: { error: 'Failed to fetch feedback' }
            };
    ...
    if (method === 'GET' && path.match(/^\/[^\/]+\/responses$/)) {
        ...
        try {
            ...
            logger.error('[Feedback] error fetching responses', user?.id, { detail: error?.message || 'Unknown error' });
    ...
    if (method === 'POST' && path.match(/^\/vote\/[^\/]+$/)) {
        ...
        try {
            ...
            logger.error('[Feedback] error voting on feedback', user?.id, { detail: error?.message || 'Unknown error' });
    ...
    if (method === 'POST' && (path === '' || path === '/')) {
        ...
        try {
            ...
            logger.error('[Feedback] error submitting feedback', user?.id, { detail: error?.message || 'Unknown error' });
            return {
                status: 500,
