...
async function seedCalendarEvents(userId) {
    ...
    const events = [
        ...
        { title: 'Poshmark Closet Share', description: 'Scheduled daily closet sharing automation', type: 'automation', color: '#f59e0b', date: day(1), time: '09:00' },
        ...
        { title: 'eBay Listing Refresh', description: 'Refresh stale listings for better placement', type: 'automation', color: '#f59e0b', date: day(2), time: '08:00' },
        ...
        { title: 'Send Offers to Likers', description: 'Automated offer blast to all watchers', type: 'automation', color: '#f59e0b', date: day(5), time: '19:00' },
