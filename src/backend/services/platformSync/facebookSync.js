...
// Wire trackApiLatency once Facebook Graph API calls replace Chrome extension stubs.
...
export async function syncFacebookShop(shop) {
    ...
    try {
        ...
        if (oauthMode === 'mock') {
            ...
            results.message =
                'Facebook sync requires connected account with valid credentials. Use Automations to sync via browser automation.';
