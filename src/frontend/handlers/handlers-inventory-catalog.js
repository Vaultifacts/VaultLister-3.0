    ...
    _renderExperimentsList: function(experiments) {
        ...
        return experiments.map(exp => {
            ...
            return '<div class="card mb-3" style="border-left:3px solid ' + statusColor + ';">' +
                ...
                '<div class="text-xs text-gray-400">' + escapeHtml(exp.base_rule_name || exp.base_rule_id || '') + '</div></div>' +
                ...
                '<div class="text-xs text-gray-400">' + escapeHtml(exp.variant_rule_name || exp.variant_rule_id || '') + '</div></div></div>' +
