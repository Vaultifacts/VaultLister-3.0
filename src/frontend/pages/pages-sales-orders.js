    ...
    sales() {
        ...
        return `
            <div class="page-header">
                <h1 class="page-title">Sales &amp; Purchases</h1>
                <p class="page-description">Track your sales and sourcing purchases</p>
            </div>

            <div class="tab-bar" style="margin-bottom: 24px;">
                <button class="tab ${salesMainTab === 'sales' ? 'active' : ''}"
                    onclick="store.setState({salesMainTab:'sales'}); renderApp(window.pages.sales())">
                    Sales
                </button>
                <button class="tab ${salesMainTab === 'purchases' ? 'active' : ''}"
                    onclick="store.setState({salesMainTab:'purchases'}); renderApp(window.pages.sales())">
                    Purchases
                </button>
            </div>
                            ...
                            <tbody>
                                ${purchases.map(p => `
                                    <tr>
                                        ...
                                        <td>C$${(p.total_amount || 0).toFixed(2)}</td>
                                        <td><span class="badge badge-${p.status === 'completed' ? 'success' : p.status === 'pending' ? 'warning' : 'danger'}">${p.status || 'completed'}</span></td>
