                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ${items.map(item => {
                                    ...
                                    const imageHtml = imageUrl && isValidImageUrl(imageUrl) ?
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ${archivedListings.map(listing => {
                                        ...
                                        const firstImage = firstImageRaw && isValidImageUrl(firstImageRaw) ? firstImageRaw : 'https://placehold.co/60x60?text=No+Image';
                                        return `
                                            <tr>
                                                <td>
