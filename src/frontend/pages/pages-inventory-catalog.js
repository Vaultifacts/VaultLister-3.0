...
Object.assign(pages, {
    ...
    automations() {
        // Define all available automation presets
        const allPresets = [
            // Sharing automations
                            ...
                            <div class="card-body">
                                ...
                                <div class="sku-rule-example mt-3">
                                    ...
                                    <div class="sku-preview" id="sku-preview-${rule.id}">
                                        <button class="btn btn-sm btn-ghost" onclick="handlers.previewSkuPatternForRule('${rule.id}', '${escapeHtml(rule.pattern).replace(/'/g, "\\'")}')">
                                            Generate Preview
                                        </button>
                                    </div>
                                </div>
