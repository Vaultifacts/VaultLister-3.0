...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=c5b9386d',
    '/styles/main.css?v=c5b9386d',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=c5b9386d',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=c5b9386d',
    '/chunk-tools.js?v=c5b9386d',
    '/chunk-intelligence.js?v=c5b9386d',
    '/chunk-settings.js?v=c5b9386d',
    '/chunk-community.js?v=c5b9386d',
];
