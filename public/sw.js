...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=ebef96d2',
    '/styles/main.css?v=ebef96d2',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=ebef96d2',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=ebef96d2',
    '/chunk-tools.js?v=ebef96d2',
    '/chunk-intelligence.js?v=ebef96d2',
    '/chunk-settings.js?v=ebef96d2',
    '/chunk-community.js?v=ebef96d2',
];
