...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=25ebe160',
    '/styles/main.css?v=25ebe160',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=25ebe160',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=25ebe160',
    '/chunk-tools.js?v=25ebe160',
    '/chunk-intelligence.js?v=25ebe160',
    '/chunk-settings.js?v=25ebe160',
    '/chunk-community.js?v=25ebe160',
];
