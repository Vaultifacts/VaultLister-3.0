...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=017bf597',
    '/styles/main.css?v=017bf597',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=017bf597',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=017bf597',
    '/chunk-tools.js?v=017bf597',
    '/chunk-intelligence.js?v=017bf597',
    '/chunk-settings.js?v=017bf597',
    '/chunk-community.js?v=017bf597',
];
