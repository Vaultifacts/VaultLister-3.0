...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=92a0f6a4',
    '/styles/main.css?v=92a0f6a4',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=92a0f6a4',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=92a0f6a4',
    '/chunk-tools.js?v=92a0f6a4',
    '/chunk-intelligence.js?v=92a0f6a4',
    '/chunk-settings.js?v=92a0f6a4',
    '/chunk-community.js?v=92a0f6a4',
];
