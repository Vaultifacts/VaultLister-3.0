...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=9ad5ded0',
    '/styles/main.css?v=9ad5ded0',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=9ad5ded0',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=9ad5ded0',
    '/chunk-tools.js?v=9ad5ded0',
    '/chunk-intelligence.js?v=9ad5ded0',
    '/chunk-settings.js?v=9ad5ded0',
    '/chunk-community.js?v=9ad5ded0',
];
