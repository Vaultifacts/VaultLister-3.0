...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=d3270912',
    '/styles/main.css?v=d3270912',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=d3270912',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=d3270912',
    '/chunk-tools.js?v=d3270912',
    '/chunk-intelligence.js?v=d3270912',
    '/chunk-settings.js?v=d3270912',
    '/chunk-community.js?v=d3270912',
];
