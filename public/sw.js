...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=d1ff4162',
    '/styles/main.css?v=d1ff4162',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=d1ff4162',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=d1ff4162',
    '/chunk-tools.js?v=d1ff4162',
    '/chunk-intelligence.js?v=d1ff4162',
    '/chunk-settings.js?v=d1ff4162',
    '/chunk-community.js?v=d1ff4162',
];
