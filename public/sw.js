...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=2acaf13f',
    '/styles/main.css?v=2acaf13f',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=2acaf13f',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=2acaf13f',
    '/chunk-tools.js?v=2acaf13f',
    '/chunk-intelligence.js?v=2acaf13f',
    '/chunk-settings.js?v=2acaf13f',
    '/chunk-community.js?v=2acaf13f',
];
