...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=d2249dd6',
    '/styles/main.css?v=d2249dd6',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=d2249dd6',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=d2249dd6',
    '/chunk-tools.js?v=d2249dd6',
    '/chunk-intelligence.js?v=d2249dd6',
    '/chunk-settings.js?v=d2249dd6',
    '/chunk-community.js?v=d2249dd6',
];
