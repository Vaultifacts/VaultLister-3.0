...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=f574ad32',
    '/styles/main.css?v=f574ad32',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=f574ad32',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=f574ad32',
    '/chunk-tools.js?v=f574ad32',
    '/chunk-intelligence.js?v=f574ad32',
    '/chunk-settings.js?v=f574ad32',
    '/chunk-community.js?v=f574ad32',
];
