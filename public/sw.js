...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=be1d37be',
    '/styles/main.css?v=be1d37be',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=be1d37be',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=be1d37be',
    '/chunk-tools.js?v=be1d37be',
    '/chunk-intelligence.js?v=be1d37be',
    '/chunk-settings.js?v=be1d37be',
    '/chunk-community.js?v=be1d37be',
];
