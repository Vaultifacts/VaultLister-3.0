...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=b3857bef',
    '/styles/main.css?v=b3857bef',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=b3857bef',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=b3857bef',
    '/chunk-tools.js?v=b3857bef',
    '/chunk-intelligence.js?v=b3857bef',
    '/chunk-settings.js?v=b3857bef',
    '/chunk-community.js?v=b3857bef',
];
