...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=ce943ecc',
    '/styles/main.css?v=ce943ecc',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=ce943ecc',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=ce943ecc',
    '/chunk-tools.js?v=ce943ecc',
    '/chunk-intelligence.js?v=ce943ecc',
    '/chunk-settings.js?v=ce943ecc',
    '/chunk-community.js?v=ce943ecc',
];
