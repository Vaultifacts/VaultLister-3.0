...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=521bbef0',
    '/styles/main.css?v=521bbef0',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=521bbef0',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=521bbef0',
    '/chunk-tools.js?v=521bbef0',
    '/chunk-intelligence.js?v=521bbef0',
    '/chunk-settings.js?v=521bbef0',
    '/chunk-community.js?v=521bbef0',
];
