...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=dcc8189a',
    '/styles/main.css?v=dcc8189a',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=dcc8189a',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=dcc8189a',
    '/chunk-tools.js?v=dcc8189a',
    '/chunk-intelligence.js?v=dcc8189a',
    '/chunk-settings.js?v=dcc8189a',
    '/chunk-community.js?v=dcc8189a',
];
