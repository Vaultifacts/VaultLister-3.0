...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=ccd24268',
    '/styles/main.css?v=ccd24268',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=ccd24268',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=ccd24268',
    '/chunk-tools.js?v=ccd24268',
    '/chunk-intelligence.js?v=ccd24268',
    '/chunk-settings.js?v=ccd24268',
    '/chunk-community.js?v=ccd24268',
];
