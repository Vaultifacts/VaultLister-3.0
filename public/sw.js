...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=bdb3a973',
    '/styles/main.css?v=bdb3a973',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/logo/Favicon/favicon-64.png',
    '/chunk-inventory.js?v=bdb3a973',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=bdb3a973',
    '/chunk-tools.js?v=bdb3a973',
    '/chunk-intelligence.js?v=bdb3a973',
    '/chunk-settings.js?v=bdb3a973',
    '/chunk-community.js?v=bdb3a973',
];
