...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=138a31a0',
    '/styles/main.css?v=138a31a0',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=138a31a0',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=138a31a0',
    '/chunk-tools.js?v=138a31a0',
    '/chunk-intelligence.js?v=138a31a0',
    '/chunk-settings.js?v=138a31a0',
    '/chunk-community.js?v=138a31a0',
];
