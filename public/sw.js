...
const PRECACHE_URLS = [
    '/',
    '/core-bundle.js?v=f95e6f70',
    '/styles/main.css?v=f95e6f70',
    '/manifest.webmanifest',
    '/offline.html',
    '/assets/favicon.svg',
    '/chunk-inventory.js?v=f95e6f70',
];

// Secondary chunks — fetched in the background during activate
const BACKGROUND_CACHE_URLS = [
    '/chunk-sales.js?v=f95e6f70',
    '/chunk-tools.js?v=f95e6f70',
    '/chunk-intelligence.js?v=f95e6f70',
    '/chunk-settings.js?v=f95e6f70',
    '/chunk-community.js?v=f95e6f70',
];
